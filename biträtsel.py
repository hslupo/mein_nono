"""
Erster Versuch, bei großen Rätseln sehr langsam
beim Berechnen der Vorgaben deshalb mit 'geklautem' weitergemacht
--> nono.py
Aufgaben:   Asymetrisch Rätsel lösen
            beschleunigen der Vorgaben
"""
...
if __name__ == '__main__':
    ...
    if zeilen_zahl != spalten_zahl:
        print(f'\n\n{fn} ist ein asymetrisches Rätsel, \ndas kann leider hier noch nicht gelöst werden, Sorry')
        quit(666)
